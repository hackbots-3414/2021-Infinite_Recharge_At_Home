...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 8.45;
  ...
  public void robotInit() {
    ...
    WPI_TalonSRX leftFollowerID2 = setupWPI_TalonSRX(2, Sides.FOLLOWER, false);
    leftFollowerID2.follow(leftMotor);

    WPI_TalonSRX rightMotor = setupWPI_TalonSRX(4, Sides.RIGHT, false);
    WPI_TalonSRX rightFollowerID5 = setupWPI_TalonSRX(5, Sides.FOLLOWER, false);    
